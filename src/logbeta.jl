...
let
    ...
    fig = Figure(resolution = (600, 600), font = "Arial", backgroundcolor = :honeydew) # probably you need to install this font in your system
    ...
    display(fig)
    save(path * "logbeta_graph.png", fig)
end;
