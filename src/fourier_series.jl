...
x = 0.0:0.001:1.0
k = 10
colors = [RGB(0.0, 1.0, 0.4), RGB(0, 1.0, 1.0), RGB(1.0, 0.25, 0.25), RGB(1.0, 1.0, 0.0), RGB(1.0, 0.5, 1.0), RGB(0.75, 0.75, 1.0), RGB(0.75, 0.35, 1), RGB(0.35, 0.75, 1), RGB(0.75, 0.35, 1), RGB(1, 0.75, 0.35)]
waves = Object[]
for i = 1:k
